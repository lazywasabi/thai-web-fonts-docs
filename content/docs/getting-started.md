...
ในหน้าข้อมูลฟอนต์จะมีโค้ดพร้อมใช้อยู่ โค้ดนี้จะรองรับฟอนต์ทุกน้ำหนัก เฉพาะรูปแบบปกติ ซึ่งครอบคลุมการใช้งานส่วนใหญ่ สามารถฝังไฟล์ CSS (`<link>`) หรือคัดลอก CSS (`@font-face`, `@import`) ไปใช้งานได้เลย
...
สำหรับผู้ที่ต้องการใช้งานฟอนต์รูปแบบอื่นๆ หากฟอนต์นั้นรองรับ เช่น ตัวเอียง (italic) หรือแบบแคบ (condensed) สามารถปรับแต่ง CSS ได้ด้วยตัวเอง โดยในแต่หน้าข้อมูลฟอนต์จะมีรายชื่อไฟล์ที่ใช้งานได้ทั้งหมดอยู่
