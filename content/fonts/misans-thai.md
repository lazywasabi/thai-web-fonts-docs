...
font:
  ...
  external: true
  previewFile: https://thaiwebfonts-files.pages.dev/fonts/MiSansThaiVF.woff2
  weight:
...
@font-face {
  ...
  src: url('https://thaiwebfonts-files.pages.dev/fonts/MiSansThaiVF.woff2') format('woff2');
  font-style: normal;
  font-weight: 150 700;
  font-display: swap;
}
...
@font-face {
  ...
  src: url('https://thaiwebfonts-files.pages.dev/fonts/MiSansLatinVF.woff2') format('woff2');
  font-style: normal;
  font-weight: 150 700;
  font-display: swap;
}
